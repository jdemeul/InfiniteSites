...
parhitsdf <- read.delim(file = "/srv/shared/vanloo/home/jdemeul/projects/2016-17_ICGC/infinite_sites/results/InfSitesByAF_alphapt01_hetonly_cleanhits_variants_v2_2021.txt", as.is = T, sep = "\t")
...
pardriv <- read.delim(file = "/srv/shared/vanloo/home/jdemeul/projects/2016-17_ICGC/infinite_sites/results/annovar/InfSitesByAF_alphapt01_hetonly_cleanhits_variants_v2_2021.hg19_multianno.txt", as.is = T)
pardrivorig <- read.delim(file = "/srv/shared/vanloo/home/jdemeul/projects/2016-17_ICGC/infinite_sites/results/InfSitesByAF_alphapt01_hetonly_cleanhits_variants_v2_2021.txt", as.is = T, header = T)
...
thirddriv1 <- read.delim(file = "/srv/shared/vanloo/home/jdemeul/projects/2016-17_ICGC/infinite_sites/results/annovar/InfSitesBiallelicM2recall_variants_20210217_alt1.hg19_multianno.txt", as.is = T)
thirddriv2 <- read.delim(file = "/srv/shared/vanloo/home/jdemeul/projects/2016-17_ICGC/infinite_sites/results/annovar/InfSitesBiallelicM2recall_variants_20210217_alt2.hg19_multianno.txt", as.is = T)
thirddrivorig <- read.delim(file = "/srv/shared/vanloo/home/jdemeul/projects/2016-17_ICGC/infinite_sites/results/InfSitesBiallelicM2recall_variants_20210217.txt", as.is = T)
...
write.table(x = pardrivhitex, file = "/srv/shared/vanloo/home/jdemeul/projects/2016-17_ICGC/infinite_sites/results/annovar/InfSitesByAF_alphapt01_hetonly_cleanhits_variants_v2_2021_exondrivers.txt", quote = F, sep = "\t", row.names = F, col.names = T)
write.table(x = thirddrivhitex, file = "/srv/shared/vanloo/home/jdemeul/projects/2016-17_ICGC/infinite_sites/results/annovar/InfSitesBiallelicM2recall_variants_20210217_exondrivers.txt", quote = F, sep = "\t", row.names = F, col.names = T)
