...
# 
# write.table(x = outrates, file = "/camp/project/proj-emedlab-vanloo/jdemeul/projects/2016-17_ICGC/infinite_sites/results/mutation_rate_comparison_at_par-nonpar_loci.txt", quote = F, col.names = T, row.names = F, sep = "\t")
# 
# 
# #### quick sim test
# 
